CREATE TABLE `template_field_attributes` (
	...
	CONSTRAINT `field_id` FOREIGN KEY (`field_id`) REFERENCES `certificates_db`.`template_fields` (`id`) ON UPDATE RESTRICT ON DELETE CASCADE
)
